...
package com.swmem.voicetoview.jni;

import java.nio.ByteBuffer;

/**
 * This is *not* a full JNI wrapper for the FLAC codec, but merely exports the
 * minimum of functions necessary for the purposes of the Audioboo client.
 *
 * Note that we're not using ByteBuffer here as we do in FLACStreamEncoder; this
 * is because AudioTrack (see FLACPlayer) doesn't support ByteBuffer.
 **/
public class FLACStreamDecoder {
	...
	/**
	 * Initialize the stream decoder with the file given by infile. TODO: Will
	 * possibly need a different constructor that accepts URLs.
	 **/
	 ...
	 * buffer must be at least minBufferSize() in size. Returns the number of
	 * bytes actually read, or -1 on fatal errors.
	 **/
