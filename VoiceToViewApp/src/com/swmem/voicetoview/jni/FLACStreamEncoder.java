...
public class FLACStreamEncoder {
	...
	/**
	 * channels must be either 1 (mono) or 2 (stereo) bits_per_sample must be
	 * either 8 or 16
	 **/
	...
	/**
	 * Returns the maximum amplitude written to the file since the last call to
	 * this function.
	 **/
	native public float getMaxAmplitude();

	/**
	 * Returns the average amplitude written to the file since the last call to
	 * this function.
	 **/
	 ...
	 * as the provided buffer size. Returns the number of bytes actually
	 * written.
	 **/
