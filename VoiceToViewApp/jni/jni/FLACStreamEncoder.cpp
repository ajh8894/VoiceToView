...
static char const * const FLACStreamEncoder_classname =
		"com.swmem.voicetoview.jni.FLACStreamEncoder";
...
void Java_com_swmem_voicetoview_jni_FLACStreamEncoder_init(JNIEnv * env, jobject obj,
...
void Java_com_swmem_voicetoview_jni_FLACStreamEncoder_deinit(JNIEnv * env, jobject obj) {
	FLACStreamEncoder * encoder = get_encoder(env, obj);
	delete encoder;
	set_encoder(env, obj, NULL);
}

jint Java_com_swmem_voicetoview_jni_FLACStreamEncoder_write(JNIEnv * env, jobject obj,
...
void Java_com_swmem_voicetoview_jni_FLACStreamEncoder_flush(JNIEnv * env, jobject obj) {
	FLACStreamEncoder * encoder = get_encoder(env, obj);
...
jfloat Java_com_swmem_voicetoview_jni_FLACStreamEncoder_getMaxAmplitude(JNIEnv * env,
		jobject obj) {
	FLACStreamEncoder * encoder = get_encoder(env, obj);
...
jfloat Java_com_swmem_voicetoview_jni_FLACStreamEncoder_getAverageAmplitude(JNIEnv * env,
		jobject obj) {
	FLACStreamEncoder * encoder = get_encoder(env, obj);
