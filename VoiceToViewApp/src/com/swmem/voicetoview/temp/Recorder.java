 ...
 * for a Boo.
 *
 * Recorder is a leaky abstraction of FLACRecorder; FLACRecorder's message codes
 * are re-used and so is FLACRecorder.Amplitudes.
 **/
public class Recorder {
	...
	public boolean isPausing() {
		double pauseScore = mFLACRecorder.getPauseScore();
		Log.i("isPausing()", "Pause score: " + pauseScore);
		return pauseScore > 7;
	}
}
